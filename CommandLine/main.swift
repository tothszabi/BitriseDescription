...
//  CommandLine
//
//  Created by Szabolcs Toth on 06/02/2024.
//
            ...
            steps: [
                .step(
                    ...
                    inputs: [
                        .input(
                            key: "xctestrun",
                            value: "$BITRISE_TEST_BUNDLE_PATH/BullsEye_UITests_iphonesimulator15.2-arm64-x86_64.xctestrun"
                        ),
                        .input(
                            key: "destination",
                ...
                .step(
                    ...
                    inputs: [
                        .input(
                            ...
                            value: "$BITRISE_XCRESULT_PATH:BITRISE_UI_TEST_XCRESULT_PATH"
                        )
                    ]
                )
            ]
        ...
        .workflow(
            ...
            steps: [
                ...
                .step(
                    ...
                    version: .upToNextMinor(from: "8.0")
                ),
                .step(
                ...
                .step(
                    ...
                    version: .upToNextMinor(from: "1.0"),
                    runIf: ".IsCI",
                    inputs: [
                        .input(
                            key: "variables",
